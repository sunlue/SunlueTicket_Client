		...
		<view class="wrapper">
			...
			<view class="input-content">
				<view class="input-item">
					<text :class="['tit',(!account && !mobile)?'error':'']">账号</text>
					<input type="text" placeholder="请输入账号" data-key="account" @input="inputChange" />
				</view>
				<view class="input-item">
					<text :class="['tit',(!account && !mobile)?'error':'']">手机号</text>
					<input type="number" placeholder="请输入手机号" data-key="mobile" @input="inputChange" />
				</view>
				<view class="input-item">
				...
				<view class="input-item">
					<text :class="['tit',!passwords?'error':'']">确认密码</text>
					<input type="password" placeholder="请确认密码" data-key="passwords" @input="inputChange" />
				</view>
			</view>
