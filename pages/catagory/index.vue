	...
	<view>
		<view class="category-list">
			...
			<scroll-view scroll-y="true" class="left">
				<view class="row" v-for="(category,index) in categoryList" :key="category.uniqid" :class="[index==showCategoryIndex?'on':'']"
			...
			<scroll-view scroll-y="true" class="right">
				<view class="category" v-for="(category,index) in categoryList" :key="index" v-show="index==showCategoryIndex">
					<view class="list">
						<view class="box" v-for="(box,i) in category.ticket" :key="i" @tap="toCategory(box)">
							<image :src="box.thumb" v-if="box.thumb"></image>
							<image src="../../static/assets/emptyImg.gif" v-if="!box.thumb"></image>
							<view class="footer">
								<view class="text">{{box.name}}</view>
								<view class="price">
									<text class="sales">已售{{box.sales}}</text>
									<text class="money">￥{{box.todayPrice}}</text>
								</view>
							</view>
						</view>
					</view>
